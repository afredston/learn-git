...
We don't have a tutorial activity for this -- I just wanted you to know it's an option. Here are some fun repositories you might be interested in forking: 
...
Let's go through exactly how that will work. The scripts for each week are stored in [the master repository](https://github.com/aeda2021/2021_master). Clone this repository onto your local machine, following the steps we just learned. 

If you've explored the [GitHub organization for AEDA 2021](https://github.com/aeda2021) at all, you probably noticed there's already a repository for your name! Clone that one too. 

To get the R scripts for the course, you need to manually duplicate them from the `2021_master` repo to the `your_name` repo on your computer. *Don't forget to frequently `pull` in the `2021_master` repo so you see course updates!* To be sure you have the hang of this, duplicate the script `2_github.R` into your personal repo, commit it, and push your changes. Check on GitHub to see that the new script has appeared in your personal repo. 
